...
$up = "UPDATE part SET stockStatus='1',editPerson = '$email',editTime=NOW() WHERE partNumber = '$partNumber'";
...
mysqli_close($conn);
    ...
    echo '<script type="text/javascript">alert("The part is available now")</script>';
